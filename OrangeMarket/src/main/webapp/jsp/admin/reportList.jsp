...
<body>
    <section id="section">
    	<div class="section-inner">
    		<div class="section-title">신고내역 관리</div>
    		<div class="section-content">
    			<div class="section-search">
		    		<select id="refield" name="refield" class="section-search-field">
				...
				<div class="section-main">
					<table>
						...
						<c:forEach var="list" items="${list}">
							<tr>
								...
								<td class="board-tit">
								<a href="javascript:report_detail(${list.unq})">${list.title}</a>
								</td>
					...
					<article class="pager-wrap">
						<ul class="pager">
							...
							<li><a href="admin-reportlist?pageNo=${before}&field=${page.field}">&lt;</a></li>
							</c:if>	
								<c:forEach var="pageNo" begin="${page.startPage}" end="${page.endPage}">
									<c:choose>
									<c:when  test="${pageNo == page.pageNo }">
										<li class="on"><a href="admin-reportlist?pageNo=${pageNo}&field=${page.field}">${pageNo}</a></li>
									</c:when>
									<c:when test="${pageNo != page.pageNo }">
										<li><a href="admin-reportlist?pageNo=${pageNo}&field=${page.field}">${pageNo}</a></li>
									</c:when>
									</c:choose>
								</c:forEach>
							<c:if test="${page.endPage != page.totalPage }">
							<li><a href="admin-reportlist?pageNo=${next}&field=${page.field}">&gt;</a></li>
							</c:if>		
						</ul>
					</article>
					</div>
