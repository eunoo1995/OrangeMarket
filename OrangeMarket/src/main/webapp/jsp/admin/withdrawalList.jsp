    	...
    	<div class="section-inner">
    		...
    		<div class="section-content">
    			<div class="section-search">
		    		...
		    		<button id="searchWith"><img src="/images/admin/search_w.png"></button>
    			</div>
				<div class="section-main">
					<table>
						...
						<tr style="display:none; font-size:14px;">
							...
							<td class="liner"><div class="detail">탈퇴사유</div><br>${list.reason}</td>
							<td class="liner"><div class="detail">탈퇴일</div><br>${list.udate}</td>
							<td class="liner">
					...
					<article class="pager-wrap">
						<ul class="pager">
							...
							<li><a href="admin-withdrawallist?pageNo=${before}&word=${page.word}">&lt;</a></li>
							</c:if>	
								<c:forEach var="pageNo" begin="${page.startPage}" end="${page.endPage}">
									<c:choose>
									<c:when  test="${pageNo == page.pageNo }">
										<li class="on"><a href="admin-withdrawallist?pageNo=${pageNo}&word=${page.word}">${pageNo}</a></li>
									</c:when>
									<c:when test="${pageNo != page.pageNo }">
										<li><a href="admin-withdrawallist?pageNo=${pageNo}&word=${page.word}">${pageNo}</a></li>
									</c:when>
									</c:choose>
								</c:forEach>
							<c:if test="${page.endPage != page.totalPage }">
							<li><a href="admin-withdrawallist?pageNo=${next}&word=${page.word}">&gt;</a></li>
							</c:if>		
						</ul>
					</article>
					</div>
