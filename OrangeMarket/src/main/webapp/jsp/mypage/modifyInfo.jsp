		...
		<div class="cont-inner">
			...
			<article class="find-account-wrap">
				<header class="sub-page-head">
					<div class="cont-inner">
						<h2 class="sub-page-title">회원정보수정</h2>
					</div>
				</header>
					...
					<table class="form-table">
						...
						<tbody>
							<tr>
								<td colspan="2">
									...
									<input type="text" name="userName" required value="${vo.userName}"/>
							...
							<tr>
								<td colspan="2">
									...
									<input type="text" name="tel" placeholder="- 없이 숫자만 입력해주세요" required value="${vo.userPhone}"/>
									<p class="form-err-msg"></p>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									...
									<input type="text" name="nickname" minlength="3" maxlength="12" placeholder="닉네임(3-12자리)" required value="${vo.nikName}"/>
									<p class="form-err-msg"></p>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2">
									...
									<input type="text" name="email" class="with-btn-2" placeholder="아이디@naver.com 형식으로 입력해주세요" required value="${vo.email}"/>
							...
							<tr>
								<td colspan="2">
									...
									<input type="text" name="addrArea" placeholder="주소를 입력해주세요" value="${vo.addr}"/>
						...
						<tfoot>
							<tr>
								<td colspan="2">
									<div class="btn-group">
										<a href="mypage" class="btn btn-solid btn-half">취소하기</a>
